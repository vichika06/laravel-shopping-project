...
<head>
  ...
  <link rel="stylesheet" href="{{url('style/demo.css')}}" />
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">vk</span>
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="{{route('view-logo')}}" class="menu-link">
                  <div data-i18n="Without menu">View Logo</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="{{route('add-logo')}}" class="menu-link">
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img src="/assets/image/{{Auth::User()->profile}}" alt class="w-px-40  rounded-circle" />
                  </div>
                </a>
